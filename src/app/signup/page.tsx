            ...
            <div className=" text-white  rounded-lg border shadow-lg p-5 box-content h-2/3 m-2  w-full md:w-1/2 lg:w-1/3 ">
                <div >
                    <div className="">
                        ...
                        type="text" 
                        id="email" 
                        className="bg-gray-50 border  border-gray-300 text-gray-900  rounded-lg focus:ring-[#1da1f2] focus:border-[#1da1f2] block w-full p-2.5 " 
                        placeholder="foo.bar@mail.com" 
                        required
                        onChange={(e) => {setEmail(e.target.value)}} />
                    </div>
                    <div>
                        <label htmlFor="Email Address" className="block mb-2  text-gray-900 text-white ">Password</label>
                        <input 
                        type="password" 
                        id="password" 
                    ...
                    <div className="pb-5">
                        <label htmlFor="Name" className="block mb-2  text-gray-900 text-white">Name</label>
                        <input 
                        type="text" 
                        id="name" 
                        className="bg-gray-50 border  border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " 
